                ...
                <td style="border:1 solid" align="center">
                    <table rules="rows" border="0" cellspacing="0" width="100%">
						...
						<tr height="30">
							...
							<td align="center" style="text-indent:5"><a href="ViewSearchInfoByIdServlet?infoid=${info.infoid }">${info.infoTitle }</a></td>
            	...
            	<tr>
            		<td>
            			<c:if test="${currentPage!=1 }">
        					<a href="ShowMoreServlet?currentPage=${currentPage-1 }&payforType=${payforType}&stateType=${stateType}&infoType=${infoType}">上一页</a>
        				</c:if>
        				<c:if test="${currentPage!=totalPage }">
        					<a href="ShowMoreServlet?currentPage=${currentPage+1 }&payforType=${payforType}&stateType=${stateType}&infoType=${infoType}">下一页</a>
        				</c:if>
        			</td>
        		</tr>
        	</tbody>
