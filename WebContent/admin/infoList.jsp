...
<tbody><tr>
   <td align="left" height="400" bgcolor="#FFFFFF" valign="top" width="670">        
            ...
            <tr>
                <td style="border:1 solid" align="center">
                    <table rules="rows" border="0" cellspacing="0" width="100%">
						...
						<tr height="30">
							<td align="center">${info.infoid }</td>
							<td align="center" style="text-indent:10">${info.typeIntro }</td>
							<td align="center" style="text-indent:5"><a href="SearchInfoByIdServlet?infoid=${info.infoid }">${info.infoTitle }</a></td>
    ...
    <table border="0" cellspacing="0" width="690">
        <tbody><tr>
            	...
            	<tr>
            		<td>
            			<c:if test="${currentPage!=1 }">
        					<a href="InfoListServlet?currentPage=${currentPage-1 }&payforType=${payforType}&stateType=${stateType}&infoType=${infoType}">上一页</a>
        				</c:if>
        				<c:if test="${currentPage!=totalPage }">
        					<a href="InfoListServlet?currentPage=${currentPage+1 }&payforType=${payforType}&stateType=${stateType}&infoType=${infoType}">下一页</a>
        				</c:if>
        			</td>
        		</tr>
        	</tbody>
