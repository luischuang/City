...
<body background="images/back.gif">
    <center>
        <table border="0" width="920" cellspacing="0" cellpadding="0" bgcolor="white">
			...
			<td colspan="2">
			<!-- 页眉 -->
			<iframe src="view/addtop.jsp" frameBorder="0" width="920" scrolling="no" height="200" ></iframe>
            ...
            <tr>
                ...
                <td width="100%" height="400" align="center" valign="top" bgcolor="#FFFFFF">
									...
									<td align="center">
										<table border="0" width="650"  cellspacing="8">                    
											...
											<tr>
												...
												<td colspan="2"><input type="text" name="infoTitle" size="80" maxlength="40" value="" id="infoTitle"/></td>                        
											</tr>
											<tr><td colspan="3"></td></tr>
											<tr>
											...
											<textarea name="infoContent" id="infoContent" cols="75" rows="10"  
											onkeydown="check(infoContent,ContentUse,ContentRem,500)" 
											onkeyup="check(infoContent,ContentUse,ContentRem,500)" 
											onchange="check(infoContent,ContentUse,ContentRem,500)"></textarea></td>
											</tr>
											<tr>
