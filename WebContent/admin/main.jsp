...
<body>
    <center>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="688" height="auto">
            ...
            <tr><td background="../images/default_m2.jpg" valign="top">
				<!-- 内容区 -->
				<iframe src="default.jsp" name="default" frameBorder="0" width="650" scrolling="no" height="300" style="margin-left:10"></iframe>
