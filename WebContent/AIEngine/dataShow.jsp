...
<head>
    ...
    <link href="../AIEngine/assets/css/font-awesome.css" rel="stylesheet" />
     <!-- Morris Chart Styles-->
    <link href="../AIEngine/assets/js/morris/morris-0.4.3.min.css" rel="stylesheet" />
        <!-- Custom Styles-->
...
<body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                		<a href="dataSet.jsp"><i class="fa fa-edit"></i>数据集</a>
                	</li>
                	<li>
                        <a href="dataShow.jsp"  class="active-menu"><i class="fa fa-bar-chart-o"></i>展示</a>
                    </li>
                    <li>
    ...
    <script src="../AIEngine/assets/js/jquery.metisMenu.js"></script>
     <!-- Morris Chart Js -->
     <script src="../AIEngine/assets/js/morris/raphael-2.1.0.min.js"></script>
    <script src="../AIEngine/assets/js/morris/morris.js"></script>
      <!-- Custom Js -->
    <script src="../AIEngine/assets/assets/js/custom-scripts.js"></script>
