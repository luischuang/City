				...
				<td width="690" height="400" align="left" valign="top" bgcolor="#FFFFFF">        
					<table border="0" width="670" cellspacing="0" cellpadding="0" style="margin-top:5;">
						<tr height="30">
							...
							<c:if test="${info.infopaystate==1 }">
							<font color="#004790"><b>■${info.typeIntro }</b></font><font color="red">已付费推广</font>
							</c:if>
							<c:if test="${info.infopaystate==0 }">
							<font color="#004790"><b>■${info.typeIntro }</b><a href="SetInfoPayforServlet?infoid=${info.infoid }" target="default">付费推广</a></font>
							</c:if>
							</td>
						</tr>
						<tr>
