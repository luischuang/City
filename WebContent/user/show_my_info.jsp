                ...
                <td style="border:1 solid" align="center">
                    <table rules="rows" border="0" cellspacing="0" width="100%">
						...
						<tr height="30">
							...
							<td align="center" style="text-indent:5"><a href="UserSearchInfoByIdServlet?infoid=${info.infoid }">${info.infoTitle }</a></td>
            	...
            	<tr>
            		<td>
            			<c:if test="${currentPage!=1 }">
        					<a href="GetMyInfoServlet?currentPage=${currentPage-1 }&user_id=${user_id}">上一页</a>
        				</c:if>
        				<c:if test="${currentPage!=totalPage }">
        					<a href="GetMyInfoServlet?currentPage=${currentPage+1 }&user_id=${user_id}">下一页</a>
        				</c:if>
        			</td>
        		</tr>
        	</tbody>
