...
/**
 * 设置信息为审核通过
 * Servlet implementation class SetInfoCheckServlet
 */
@WebServlet("/SetInfoCheckServlet")
public class SetInfoCheckServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SetInfoCheckServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(infoDao.getModifyByiId(info)){
